...
// One structured JSON line per event — printed to stdout AND appended to
// gateway.log so a request can be grepped end-to-end across both services.
...
// Derive a request ID (reuse an inbound X-Request-Id, else generate one),
// expose it on req/res, and log one structured line after the response
// finishes with method, url, status, and duration.
